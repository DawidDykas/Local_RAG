...
class TestSaveEmbeddings:
    ...
    def test_save_embeddings_without_metadata(self, qdrant_manager, sample_nodes, sample_embeddings):
...
class TestDelete:
    ...
    def test_delete_embeddings_by_file_id_success(self, qdrant_manager):
        ...
        qdrant_manager.client.query_points.return_value = Mock(
            points=[mock_point]
        )
...
class TestEdgeCases:
    ...
    def test_file_name_with_special_characters(self, qdrant_manager, sample_nodes, sample_embeddings):
